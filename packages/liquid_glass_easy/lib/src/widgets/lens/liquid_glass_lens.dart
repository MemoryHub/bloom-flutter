...
class _LiquidGlassLensState extends State<LiquidGlassLens>
  ...
  Widget _buildGlass(
    ...
    // Custom fragment shaders from this package trigger a Metal BIF0 page
    // fault on some physical iPhones. Keep the exact child/layout/gesture
    // tree, but render a shader-free translucent surface on iOS.
    if (Platform.isIOS) {
